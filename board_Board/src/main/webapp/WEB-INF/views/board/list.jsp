...
<script>
    ...
    $(document).ready(function() {
        ...
        $("a.move").on("click", function(e) {
        	...
        	// 자바스크립트로 대체 동작을 위해 정의
        	e.preventDefault();  // <a>태그의 href속성에 의한 링크기능을 제거.

        	// 클릭된 <a> 태그의 href 속성 값을 가져와 bno 변수에 저장합니다. 
        	// 여기서 this는 클릭된 <a> 태그를 가리킵니다.
            let bno = $(this).attr("href");
            
        	// form 안에 있는 name 속성이 bno인 <input> 요소를 찾아서, 
        	// 해당 요소의 값을 앞에서 가져온 bno 값으로 설정합니다.
        	$("input[name='bno']").val(bno);
			
        	// form의 action 속성 값을 "/board/get"으로 설정합니다. 
        	// form이 제출될 때 이 URL로 요청을 보냅니다.
            actionForm.attr("action", "/board/get");
            
            // form을 제출합니다. 폼의 action 속성에 설정된 URL로 데이터를 전송합니다.
        	actionForm.submit();

        });

        // 페이지번호 클릭시.
        // ul 요소 내에서 클래스가 pagination인 요소 안에 있는 모든 a 태그에 대해 클릭 이벤트 핸들러를 설정합니다.
        // 여기서 page-link 클래스는 페이지 링크를 식별하는 데 사용됩니다.
