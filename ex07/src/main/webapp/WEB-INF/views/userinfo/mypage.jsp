...
<div class="container">
    <h1 class="mt-3 md-4" style="text-align: center">내 정보</h1>
    <div class="row">
        <div class="col-4">
            <section>
                <h1>mypaage</h1>
            ...
            <form class="form-horizontal" id="ModifyForm" action="/userinfo/modify" method="post">
                <div class="card-body">
                    <div class="form-group row">  
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" readonly value='<fmt:formatDate value="${userinfo.u_regdate}" pattern="yyyy-MM-dd hh:mm:ss"/>'>
                        </div>
                        <div class="row">    
                    ...
                    <div class="form-group row">       <!-- 전화번호 -->
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="u_phone" name="u_phone" value="${userinfo.u_phone}">
                        </div>
                    </div>
                </div>
                
                    <div class="card-footer"><!-- id="btnJoin"   -->
                    <button type="button" class="btn btn-info btn-block" id="btnModify">modify</button> <!--type에 submit(전송기능있음) 이거나 button(전송기능없음) 이거나 하면 코드가 달라짐-->
                    </div>
